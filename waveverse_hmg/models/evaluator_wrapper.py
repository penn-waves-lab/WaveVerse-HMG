...
def build_models(opt):
    ...
    movement_enc.load_state_dict(model_state(checkpoint, "movement_encoder"), strict=True)
    text_enc.load_state_dict(model_state(checkpoint, "text_encoder"), strict=True)
    motion_enc.load_state_dict(model_state(checkpoint, "motion_encoder"), strict=True)
